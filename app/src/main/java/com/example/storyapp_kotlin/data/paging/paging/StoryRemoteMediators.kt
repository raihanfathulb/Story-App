package com.example.storyapp_kotlin.data.paging.paging
...
import com.example.storyapp_kotlin.data.paging.dao.RemoteKeys
import com.example.storyapp_kotlin.data.paging.dao.StoryDatabase

@OptIn(ExperimentalPagingApi::class)
class StoryRemoteMediators(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getStory( page, state.config.pageSize)
            ...
            database.withTransaction {
                ...
                database.storyDao().insertStory(responseData.stories)
            }
